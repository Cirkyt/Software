...
#line 36 "..\\main.c"
#line 1 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_rscs.h"
...
#line 39 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_rscs.h"
#line 40 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_rscs.h"
#line 41 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_rscs.h"
#line 42 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_rscs.h"
...
{
    _Bool        is_inst_stride_len_present;                                  
    _Bool        is_total_distance_present;                                   
    _Bool        is_running;                                                  
    uint16_t    inst_speed;                                                  
...
static ble_sensorsim_cfg_t               m_speed_mps_sim_cfg;                        
static ble_sensorsim_state_t             m_speed_mps_sim_state;                      
static ble_sensorsim_cfg_t               m_cadence_rpm_sim_cfg;                      
static ble_sensorsim_state_t             m_cadence_rpm_sim_state;                    
static ble_sensorsim_cfg_t               m_cadence_stl_sim_cfg;                      
static ble_sensorsim_state_t             m_cadence_stl_sim_state;                    

static app_timer_id_t                    m_battery_timer_id;                         
static app_timer_id_t                    m_rsc_meas_timer_id;                        
...
static void battery_level_update(void)
{
    ...
    {
        do { app_error_handler((err_code), 198, (uint8_t*) "..\\main.c"); } while (0);
    }
}
...
{
    p_measurement->is_inst_stride_len_present = 1;
    p_measurement->is_total_distance_present  = 0;
    p_measurement->is_running                 = 0;



    p_measurement->inst_speed         = counter();
    ...
    if (p_measurement->inst_speed > (uint32_t)(3 * 256))
    {
        p_measurement->is_running = 1;
    }
}
...
static void rsc_meas_timeout_handler(void * p_context)
{
    ...
    {
        do { app_error_handler((err_code), 281, (uint8_t*) "..\\main.c"); } while (0);
    }
}
...
static void timers_init(void)
{
    ...
    do { static uint32_t APP_TIMER_BUF[((((( (((4)) * 40) + ( 3 * (8 + (((4) + 1) + 1) * 24) ) )) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_timer_init((0), (4), (4) + 1, APP_TIMER_BUF, (0) ? app_timer_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 307, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);

    
    err_code = app_timer_create(&m_battery_timer_id,
                                APP_TIMER_MODE_REPEATED,
                                battery_level_meas_timeout_handler);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 313, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    
    err_code = app_timer_create(&m_rsc_meas_timer_id,
                                APP_TIMER_MODE_REPEATED,
                                rsc_meas_timeout_handler);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 319, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void gap_params_init(void)
{
    ...
    err_code = sd_ble_gap_device_name_set(&sec_mode,
                                          (const uint8_t *)"Nordic_RSC",
                                          strlen("Nordic_RSC"));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 339, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    err_code = sd_ble_gap_appearance_set(1088);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 342, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 352, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void advertising_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 385, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void services_init(void)
{
    ...
    rscs_init.evt_handler = 0;
    rscs_init.feature     = (0x01 << 0)|
                            (0x01 << 2);

    
    do {(&rscs_init . rsc_meas_attr_md . cccd_write_perm)->sm = 1; (&rscs_init . rsc_meas_attr_md . cccd_write_perm)->lv = 1;} while(0);
    do {(&rscs_init . rsc_meas_attr_md . read_perm)->sm = 0; (&rscs_init . rsc_meas_attr_md . read_perm)->lv = 0;} while(0);
    do {(&rscs_init . rsc_meas_attr_md . write_perm)->sm = 0; (&rscs_init . rsc_meas_attr_md . write_perm)->lv = 0;} while(0);

    do {(&rscs_init . rsc_feature_attr_md . read_perm)->sm = 1; (&rscs_init . rsc_feature_attr_md . read_perm)->lv = 1;} while(0);
    do {(&rscs_init . rsc_feature_attr_md . write_perm)->sm = 0; (&rscs_init . rsc_feature_attr_md . write_perm)->lv = 0;} while(0);

    err_code = ble_rscs_init(&m_rscs, &rscs_init);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 426, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 444, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void sensor_sim_init(void)
{
    ...
    m_speed_mps_sim_cfg.min            = (uint32_t)(0.5 * 256);
    m_speed_mps_sim_cfg.max            = (uint32_t)(6.5 * 256);
    m_speed_mps_sim_cfg.incr           = (uint32_t)(1.5 * 256);
    m_speed_mps_sim_cfg.start_at_max   = 0;

    ble_sensorsim_init(&m_speed_mps_sim_state, &m_speed_mps_sim_cfg);

    m_cadence_rpm_sim_cfg.min          = 40;
    m_cadence_rpm_sim_cfg.max          = 160;
    m_cadence_rpm_sim_cfg.incr         = 20;
    m_cadence_rpm_sim_cfg.start_at_max = 0;

    ble_sensorsim_init(&m_cadence_rpm_sim_state, &m_cadence_rpm_sim_cfg);

    m_cadence_stl_sim_cfg.min          = 20;
    m_cadence_stl_sim_cfg.max          = 125;
    m_cadence_stl_sim_cfg.incr         = 5;
    m_cadence_stl_sim_cfg.start_at_max = 0;
...
static void application_timers_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 503, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    rsc_meas_timer_ticks = ((uint32_t)((((1000) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000)));

    err_code = app_timer_start(m_rsc_meas_timer_id, rsc_meas_timer_ticks, 0);
...
static void advertising_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 522, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 531, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void on_conn_params_evt(ble_conn_params_evt_t * p_evt)
{
    ...
    if(p_evt->evt_type == BLE_CONN_PARAMS_EVT_FAILED)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 554, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    }
}
...
{
    do { app_error_handler((nrf_error), 565, (uint8_t*) "..\\main.c"); } while (0);
}
...
static void conn_params_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 588, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GAP_EVT_TIMEOUT:
            if (p_ble_evt->evt.gap_evt.params.timeout.src == 0x00)
            {
                ...
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 622, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            }
            break;
...
static void ble_stack_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 707, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    
    err_code = softdevice_sys_evt_handler_set(sys_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 711, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static uint32_t device_manager_evt_handler(dm_handle_t const    * p_handle,
                                           ...
                                           api_result_t           event_result)
{
    do { const uint32_t LOCAL_ERR_CODE = (event_result); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 739, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    return ((0x0) + 0);
}
...
static void device_manager_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 754, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    
    init_data.clear_persistent_data = (nrf_gpio_pin_read(1) == 0);

    err_code = dm_init(&init_data);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 760, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void power_manage(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 784, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
