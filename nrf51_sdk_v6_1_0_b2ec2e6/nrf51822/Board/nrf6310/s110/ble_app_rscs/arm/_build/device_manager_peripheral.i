...
{
    uint32_t size;                                      
    uint8_t  attributes[sizeof(uint32_t) * ((((((6 * (2 + 1)) + 2)) - 1) / (sizeof(uint32_t))) + 1)];  
} dm_gatts_context_t;
                                                 ...
                                                 dm_handle_t const       * p_handle)
{
    ...
    uint8_t           sys_data[sizeof(uint32_t) * ((((((6 * (2 + 1)) + 2)) - 1) / (sizeof(uint32_t))) + 1)];

    uint16_t attr_len = sizeof(uint32_t) * ((((((6 * (2 + 1)) + 2)) - 1) / (sizeof(uint32_t))) + 1);
                                    ...
                                    dm_service_context_t const * p_context)
{
    ...
    if ((p_context->context_data.p_data != 0) &&
        (
            ...
            (p_context->context_data.len < sizeof(uint32_t) * ((((((6 * (2 + 1)) + 2)) - 1) / (sizeof(uint32_t))) + 1))
        )
       )
    {
        ...
        case BLE_GAP_EVT_SEC_PARAMS_REQUEST:
            ...
            else
            {
                ...
                if (m_connection_table[index].bonded_dev_id != 0xFF)
                {
                    notify_app     = 1;
                    event.event_id = 0x16;
                    memset(m_gatts_table[index].attributes, 0, sizeof(uint32_t) * ((((((6 * (2 + 1)) + 2)) - 1) / (sizeof(uint32_t))) + 1));
