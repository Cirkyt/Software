#line 1 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_rscs.c"
...
#line 19 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_rscs.c"
...
#line 20 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_rscs.c"
#line 1 "..\\..\\..\\..\\..\\Include\\nordic_common.h"
...
#line 21 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_rscs.c"
#line 22 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_rscs.c"
#line 23 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_rscs.c"
#line 24 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_rscs.c"
...
static uint32_t rsc_measurement_char_add(ble_rscs_t * p_rscs, const ble_rscs_init_t * p_rscs_init)
{
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x2A53;} while(0);
...
static uint32_t rsc_feature_char_add(ble_rscs_t * p_rscs, const ble_rscs_init_t * p_rscs_init)
{
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x2A54;} while(0);
...
uint32_t ble_rscs_init(ble_rscs_t * p_rscs, const ble_rscs_init_t * p_rscs_init)
{
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x1814;} while(0);
...
uint32_t ble_rscs_measurement_send(ble_rscs_t * p_rscs, ble_rscs_meas_t * p_measurement)
{
    ...
    if (p_rscs->conn_handle != 0xFFFF)
    {
        uint8_t                encoded_rsc_meas[((23) - 1 - 2)];
        uint16_t               len;
        uint16_t               hvx_len;
