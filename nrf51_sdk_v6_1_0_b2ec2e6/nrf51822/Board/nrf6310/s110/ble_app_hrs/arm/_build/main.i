...
void app_error_handler(uint32_t error_code, uint32_t line_num, const uint8_t * p_file_name)
{
    ...
    { uint8_t IS_NESTED_CRITICAL_REGION = 0; uint32_t CURRENT_INT_PRI = current_int_priority_get(); if (CURRENT_INT_PRI != APP_IRQ_PRIORITY_HIGH) { uint32_t ERR_CODE = sd_nvic_critical_region_enter(&IS_NESTED_CRITICAL_REGION); if (ERR_CODE == ((0x0) + 2)) { __disable_irq(); } else { do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 165, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } };
    ...
    uint32_t temp = 1;
    while(temp);
    if (CURRENT_INT_PRI != APP_IRQ_PRIORITY_HIGH) { uint32_t ERR_CODE; __enable_irq(); ERR_CODE = sd_nvic_critical_region_exit(IS_NESTED_CRITICAL_REGION); if (ERR_CODE != ((0x0) + 2)) { do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 177, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } } };    
}
...
static void battery_level_update(void)
{
    ...
    {
        do { app_error_handler((err_code), 216, (uint8_t*) "..\\main.c"); } while (0);
    }
}
...
static void heart_rate_meas_timeout_handler(void * p_context)
{
    ...
    {
        do { app_error_handler((err_code), 261, (uint8_t*) "..\\main.c"); } while (0);
    }
...
static void timers_init(void)
{
    ...
    do { static uint32_t APP_TIMER_BUF[((((( (((6)) * 40) + ( 3 * (8 + (((4) + 1) + 1) * 24) ) )) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_timer_init((0), (6), (4) + 1, APP_TIMER_BUF, (0) ? app_timer_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 332, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);

    
    err_code = app_timer_create(&m_battery_timer_id,
                                APP_TIMER_MODE_REPEATED,
                                battery_level_meas_timeout_handler);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 338, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void gap_params_init(void)
{
    ...
    err_code = sd_ble_gap_device_name_set(&sec_mode,
                                          ...
                                          strlen("Nordic_HRM"));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 373, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 386, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void advertising_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 419, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void services_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 530, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void application_timers_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 589, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    err_code = app_timer_start(m_rr_interval_timer_id, ((uint32_t)((((300) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000))), 0);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 592, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void on_conn_params_evt(ble_conn_params_evt_t * p_evt)
{
    ...
    if(p_evt->evt_type == BLE_CONN_PARAMS_EVT_FAILED)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 641, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    }
}
...
{
    do { app_error_handler((nrf_error), 652, (uint8_t*) "..\\main.c"); } while (0);
}
...
static void conn_params_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 675, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GAP_EVT_TIMEOUT:
            if (p_ble_evt->evt.gap_evt.params.timeout.src == 0x00)
            {
                ...
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 710, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            }
            break;
...
static void ble_stack_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 795, (uint8_t*) "..\\main.c"); } while (0); } } while (0);


    
    err_code = softdevice_ble_evt_handler_set(ble_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 800, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    
    err_code = softdevice_sys_evt_handler_set(sys_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 804, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static uint32_t device_manager_evt_handler(dm_handle_t const    * p_handle,
                                           ...
                                           api_result_t           event_result)
{
    do { const uint32_t LOCAL_ERR_CODE = (event_result); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 831, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    return ((0x0) + 0);
}
...
static void device_manager_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 852, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void power_manage(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 876, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
