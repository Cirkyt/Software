#line 1 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_hts.c"
...
#line 1 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_hts.h"
...
#line 36 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_hts.h"
...
#line 37 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_hts.h"
...
#line 38 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_hts.h"
...
#line 39 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_hts.h"
...
#line 40 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_hts.h"


#line 51 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_hts.h"
...
{
    _Bool                         temp_in_fahr_units;                         
    _Bool                         time_stamp_present;                         
    _Bool                         temp_type_present;                          
...
uint32_t ble_hts_is_indication_enabled(ble_hts_t * p_hts, _Bool * p_indication_enabled);



 
#line 19 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_hts.c"
...
#line 20 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_hts.c"
#line 1 "..\\..\\..\\..\\..\\Include\\nordic_common.h"
...
#line 21 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_hts.c"
#line 22 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_hts.c"
#line 23 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_hts.c"
#line 24 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_hts.c"
...
static uint32_t hts_measurement_char_add(ble_hts_t * p_hts, const ble_hts_init_t * p_hts_init)
{
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x2A1C;} while(0);
...
static uint32_t hts_temp_type_char_add(ble_hts_t * p_hts, const ble_hts_init_t * p_hts_init)
{
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x2A1D;} while(0);
...
uint32_t ble_hts_init(ble_hts_t * p_hts, const ble_hts_init_t * p_hts_init)
{
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x1809;} while(0);

    err_code = sd_ble_gatts_service_add(0x01, &ble_uuid, &p_hts->service_handle);
    if (err_code != ((0x0) + 0))
    {
        return err_code;
    }
...
uint32_t ble_hts_measurement_send(ble_hts_t * p_hts, ble_hts_meas_t * p_hts_meas)
{
    ...
    if (p_hts->conn_handle != 0xFFFF)
    {
        uint8_t                encoded_hts_meas[((23) - 1 - 2)];
        uint16_t               len;
        uint16_t               hvx_len;
