...
#line 14 "..\\..\\..\\..\\..\\Source\\app_common\\app_gpiote.c"
...
#line 15 "..\\..\\..\\..\\..\\Source\\app_common\\app_gpiote.c"
...
#line 16 "..\\..\\..\\..\\..\\Source\\app_common\\app_gpiote.c"
#line 17 "..\\..\\..\\..\\..\\Source\\app_common\\app_gpiote.c"
...
#line 18 "..\\..\\..\\..\\..\\Source\\app_common\\app_gpiote.c"
#line 19 "..\\..\\..\\..\\..\\Source\\app_common\\app_gpiote.c"
#line 1 "..\\..\\..\\..\\..\\Include\\nrf_gpio.h"
...
#line 20 "..\\..\\..\\..\\..\\Source\\app_common\\app_gpiote.c"
...
typedef struct
{
    ...
    uint32_t                   pins_low_to_high_mask;  
    uint32_t                   pins_high_to_low_mask;  
    uint32_t                   sense_high_pins;        
    app_gpiote_event_handler_t event_handler;          
} gpiote_user_t;

typedef char static_assert_failed[(sizeof(gpiote_user_t) <= 20) ? 1 : -1];
typedef char static_assert_failed[(sizeof(gpiote_user_t) % 4 == 0) ? 1 : -1];

static uint32_t        m_enabled_users_mask;           
static uint8_t         m_user_array_size;              
static uint8_t         m_user_count;                   
static gpiote_user_t * mp_users = 0;                
...
static void sense_level_toggle(gpiote_user_t * p_user, uint32_t pins)
{
    ...
    for (pin_no = 0; pin_no < 32; pin_no++)
    {
        ...
        if ((pins & pin_mask) != 0)
        {
            ...
            ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[pin_no] |= sense;
        }
    }
}
...
void GPIOTE_IRQHandler(void)
{
    ...
    uint32_t pins_state = ((NRF_GPIO_Type *) 0x50000000UL)->IN;

    
    ((NRF_GPIOTE_Type *) 0x40006000UL)->EVENTS_PORT = 0;
    ...
    for (i = 0; i < m_user_count; i++)
    {
        ...
        if (((1 << i) & m_enabled_users_mask) != 0)
        {
            ...
            pins_changed = ((NRF_GPIO_Type *) 0x50000000UL)->IN ^ pins_state;
            if (pins_changed)
            {
...
uint32_t app_gpiote_init(uint8_t max_users, void * p_buffer)
{
    ...
    ((NRF_GPIOTE_Type *) 0x40006000UL)->INTENCLR = 0xFFFFFFFF;
...
uint32_t app_gpiote_user_enable(app_gpiote_user_id_t user_id)
{
    ...
    ((NRF_GPIOTE_Type *) 0x40006000UL)->EVENTS_PORT = 0;
    pins_state              = ((NRF_GPIO_Type *) 0x50000000UL)->IN;

    
    if (m_enabled_users_mask == 0)
    {
        ((NRF_GPIOTE_Type *) 0x40006000UL)->INTENSET = (0x1UL << (31UL));
    }
...
uint32_t app_gpiote_user_disable(app_gpiote_user_id_t user_id)
{
    ...
    if (m_enabled_users_mask == 0)
    {
        ((NRF_GPIOTE_Type *) 0x40006000UL)->INTENCLR = (0x1UL << (31UL));
    }
...
uint32_t app_gpiote_pins_state_get(app_gpiote_user_id_t user_id, uint32_t * p_pins)
{
    ...
    *p_pins = ((NRF_GPIO_Type *) 0x50000000UL)->IN & p_user->pins_mask;
