#line 1 "..\\..\\..\\..\\..\\Source\\app_common\\app_scheduler.c"
...
#line 14 "..\\..\\..\\..\\..\\Source\\app_common\\app_scheduler.c"
...
#line 15 "..\\..\\..\\..\\..\\Source\\app_common\\app_scheduler.c"
#line 16 "..\\..\\..\\..\\..\\Source\\app_common\\app_scheduler.c"
...
#line 17 "..\\..\\..\\..\\..\\Source\\app_common\\app_scheduler.c"
#line 1 "..\\..\\..\\..\\..\\Include\\s110\\nrf_soc.h"
...
#line 18 "..\\..\\..\\..\\..\\Source\\app_common\\app_scheduler.c"
#line 1 "..\\..\\..\\..\\..\\Include\\nrf_assert.h"
...
#line 19 "..\\..\\..\\..\\..\\Source\\app_common\\app_scheduler.c"
...
#line 20 "..\\..\\..\\..\\..\\Source\\app_common\\app_scheduler.c"
...
#line 21 "..\\..\\..\\..\\..\\Source\\app_common\\app_scheduler.c"
...
typedef char static_assert_failed[(sizeof(event_header_t) <= 8) ? 1 : -1];
                             ...
                             app_sched_event_handler_t handler)
{
    ...
    if (event_data_size <= m_queue_event_size)
    {
        ...
        { uint8_t IS_NESTED_CRITICAL_REGION = 0; uint32_t CURRENT_INT_PRI = current_int_priority_get(); if (CURRENT_INT_PRI != APP_IRQ_PRIORITY_HIGH) { uint32_t ERR_CODE = sd_nvic_critical_region_enter(&IS_NESTED_CRITICAL_REGION); if (ERR_CODE == ((0x0) + 2)) { __disable_irq(); } else { do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 89, (uint8_t*) "..\\..\\..\\..\\..\\Source\\app_common\\app_scheduler.c"); } while (0); } } while (0); } };

        if (!(next_index(m_queue_end_index) == m_queue_start_index))
        {
            event_index       = m_queue_end_index;
            m_queue_end_index = next_index(m_queue_end_index);
        }

        if (CURRENT_INT_PRI != APP_IRQ_PRIORITY_HIGH) { uint32_t ERR_CODE; __enable_irq(); ERR_CODE = sd_nvic_critical_region_exit(IS_NESTED_CRITICAL_REGION); if (ERR_CODE != ((0x0) + 2)) { do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 97, (uint8_t*) "..\\..\\..\\..\\..\\Source\\app_common\\app_scheduler.c"); } while (0); } } while (0); } } };
        ...
        if (event_index != 0xFFFF)
        {
            ...
            if ((p_event_data != 0) && (event_data_size > 0))
            {
...
{
    uint32_t err_code = ((0x0) + 5);

    if (!(m_queue_end_index == m_queue_start_index))
    {
...
void app_sched_execute(void)
{
    ...
    while ((app_sched_event_get(&p_event_data, &event_data_size, &event_handler) == ((0x0) + 0)))
    {
