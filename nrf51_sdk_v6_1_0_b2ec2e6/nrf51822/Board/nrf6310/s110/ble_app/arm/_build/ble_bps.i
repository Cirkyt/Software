#line 1 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_bps.c"
...
#line 1 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_bps.h"
...
#line 36 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_bps.h"
...
#line 37 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_bps.h"
...
#line 38 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_bps.h"
...
#line 39 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_bps.h"
...
#line 40 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_bps.h"


#line 48 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_bps.h"
...
{
    _Bool                         blood_pressure_units_in_kpa;                
    _Bool                         time_stamp_present;                         
    _Bool                         pulse_rate_present;                         
    _Bool                         user_id_present;                            
    _Bool                         measurement_status_present;                 
...
uint32_t ble_bps_is_indication_enabled(ble_bps_t * p_bps, _Bool * p_indication_enabled);



 
#line 19 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_bps.c"
...
#line 20 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_bps.c"
#line 1 "..\\..\\..\\..\\..\\Include\\nordic_common.h"
...
#line 21 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_bps.c"
#line 22 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_bps.c"
#line 23 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_bps.c"
#line 24 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_bps.c"
...
static uint32_t bps_measurement_char_add(ble_bps_t * p_bps, const ble_bps_init_t * p_bps_init)
{
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x2A35;} while(0);
...
static uint32_t bps_feature_char_add(ble_bps_t * p_bps, const ble_bps_init_t * p_bps_init)
{
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x2A49;} while(0);
...
uint32_t ble_bps_init(ble_bps_t * p_bps, const ble_bps_init_t * p_bps_init)
{
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x1810;} while(0);

    err_code = sd_ble_gatts_service_add(0x01, &ble_uuid, &p_bps->service_handle);
    if (err_code != ((0x0) + 0))
    {
        return err_code;
    }
...
uint32_t ble_bps_measurement_send(ble_bps_t * p_bps, ble_bps_meas_t * p_bps_meas)
{
    ...
    if (p_bps->conn_handle != 0xFFFF)
    {
        uint8_t                encoded_bps_meas[((23) - 1 - 2)];
        uint16_t               len;
        uint16_t               hvx_len;
