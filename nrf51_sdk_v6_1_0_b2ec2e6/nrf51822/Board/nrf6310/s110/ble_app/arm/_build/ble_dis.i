#line 1 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"
...
#line 19 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"
...
#line 21 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"
...
#line 22 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"
...
#line 23 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"
...
#line 24 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"
#line 1 "..\\..\\..\\..\\..\\Include\\nordic_common.h"
...
#line 25 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"
#line 26 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"
#line 27 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"
...
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_sys_id != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 51, (uint8_t*) "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"); } while (0); } } while (0);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_encoded_buffer != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 52, (uint8_t*) "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"); } while (0); } } while (0);
...
static void pnp_id_encode(uint8_t * p_encoded_buffer, const ble_dis_pnp_id_t * p_pnp_id)
{
    ...
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_pnp_id != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 75, (uint8_t*) "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"); } while (0); } } while (0);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_encoded_buffer != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 76, (uint8_t*) "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"); } while (0); } } while (0);
    ...
    do { const _Bool LOCAL_BOOLEAN_VALUE = (len == 7); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 84, (uint8_t*) "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"); } while (0); } } while (0);
}
                         ...
                         ble_gatts_char_handles_t      * p_handles)
{
    ...
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_char_value != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 109, (uint8_t*) "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"); } while (0); } } while (0);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (char_len > 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 110, (uint8_t*) "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_dis.c"); } while (0); } } while (0);
