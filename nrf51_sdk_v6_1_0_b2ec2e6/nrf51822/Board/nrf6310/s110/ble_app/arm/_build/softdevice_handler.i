...
#line 14 "..\\..\\..\\..\\..\\Source\\sd_common\\softdevice_handler.c"
#line 15 "..\\..\\..\\..\\..\\Source\\sd_common\\softdevice_handler.c"
#line 16 "..\\..\\..\\..\\..\\Source\\sd_common\\softdevice_handler.c"
#line 17 "..\\..\\..\\..\\..\\Source\\sd_common\\softdevice_handler.c"
#line 18 "..\\..\\..\\..\\..\\Source\\sd_common\\softdevice_handler.c"
#line 1 "..\\..\\..\\..\\..\\Include\\nrf_assert.h"
...
#line 27 "..\\..\\..\\..\\..\\Source\\sd_common\\softdevice_handler.c"
...
void intern_softdevice_events_execute(void)
{
    ...
    for (;;)
    {
        ...
        if (!no_more_soc_evts)
        {
            ...
            {
                do { app_error_handler((err_code), 105, (uint8_t*) "..\\..\\..\\..\\..\\Source\\sd_common\\softdevice_handler.c"); } while (0);
            }
            else
            {
        ...
        if (!no_more_ble_evts)
        {
            ...
            {
                do { app_error_handler((err_code), 128, (uint8_t*) "..\\..\\..\\..\\..\\Source\\sd_common\\softdevice_handler.c"); } while (0);
            }
            else
            {
...
#line 161 "..\\..\\..\\..\\..\\Source\\sd_common\\softdevice_handler.c"

        if (no_more_soc_evts)
        {
            
#line 172 "..\\..\\..\\..\\..\\Source\\sd_common\\softdevice_handler.c"
            
            if (no_more_ble_evts)
            {
                break;
            }
#line 188 "..\\..\\..\\..\\..\\Source\\sd_common\\softdevice_handler.c"
        }
    }
}
...
#line 282 "..\\..\\..\\..\\..\\Source\\sd_common\\softdevice_handler.c"
...
void SWI2_IRQHandler(void)
{
    if (m_evt_schedule_func != 0)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 306, (uint8_t*) "..\\..\\..\\..\\..\\Source\\sd_common\\softdevice_handler.c"); } while (0); } } while (0);
    }
    else
    {
        intern_softdevice_events_execute();
