#line 1 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_ias_c.c"
...
#line 1 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_ias_c.h"
...
#line 35 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_ias_c.h"
...
#line 36 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_ias_c.h"
...
#line 37 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_ias_c.h"
#line 38 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_ias_c.h"
...
static __inline _Bool ble_ias_c_is_ias_discovered(const ble_ias_c_t * p_ias_c)
{
    return (p_ias_c->alert_level_handle != 0x0000);
}

#line 14 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_ias_c.c"
...
#line 16 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_ias_c.c"
#line 17 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_ias_c.c"
#line 18 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_ias_c.c"
#line 19 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_ias_c.c"



static ble_uuid_t m_alert_level_uuid;        


uint32_t ble_ias_c_init(ble_ias_c_t * p_ias_c, ble_ias_c_init_t const * p_ias_c_init)
{
    if (p_ias_c_init->evt_handler == 0)
    {
        return ((0x0) + 7);
    }
    ...
    p_ias_c->conn_handle                       = 0xFFFF;
    p_ias_c->alert_level_handle                = 0x0000;

    do { m_alert_level_uuid . type = 0x01; m_alert_level_uuid . uuid = 0x2A06;} while(0);
...
static uint32_t on_connect(ble_ias_c_t * p_ias_c, ble_evt_t const * p_ble_evt)
{
    ...
    do { ias_uuid . type = 0x01; ias_uuid . uuid = 0x1802;} while(0);

    return sd_ble_gattc_primary_services_discover(p_ias_c->conn_handle, 0x0001, &ias_uuid);
}
...
static uint32_t on_srv_disc_resp(ble_ias_c_t * p_ias_c, ble_evt_t const * p_ble_evt)
{
    ...
    if (
        p_ble_evt->evt.gattc_evt.gatt_status != 0x0000
        ||
...
static void on_char_disc_resp(ble_ias_c_t * p_ias_c, const ble_evt_t * p_ble_evt)
{
    ...
    if (p_ble_evt->evt.gattc_evt.gatt_status == 0x0000)
    {
        int                                   i;
        ...
        {
            if ((((&m_alert_level_uuid)->type == (&(p_char_disc_rsp->chars[i]. uuid))->type) && ((&m_alert_level_uuid)->uuid == (&(p_char_disc_rsp->chars[i]. uuid))->uuid)))
            {
...
static void on_disconnect(ble_ias_c_t * p_ias_c, ble_evt_t const * p_ble_evt)
{
    ...
    if (p_ias_c->alert_level_handle != 0x0000)
    {
...
void ble_ias_c_on_ble_evt(ble_ias_c_t * p_ias_c, ble_evt_t const * p_ble_evt)
{
    ...
    if (err_code != ((0x0) + 0) && p_ias_c->error_handler != 0)
    {
