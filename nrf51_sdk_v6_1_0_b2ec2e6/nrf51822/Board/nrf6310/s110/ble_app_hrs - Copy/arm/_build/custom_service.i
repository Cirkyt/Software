...
#line 10 "Custom_Service.c"
#line 11 "Custom_Service.c"
#line 12 "Custom_Service.c"
...
uint32_t ble_lbs_init(ble_lbs_t * p_lbs, const ble_lbs_init_t * p_lbs_init)
{
    ...
    ble_uuid.type = p_lbs->uuid_type;
    ble_uuid.uuid = 0x1523;

    err_code = sd_ble_gatts_service_add(0x01, &ble_uuid, &p_lbs->service_handle);
    if (err_code != ((0x0) + 0))
    {
        return err_code;
    }
