#line 1 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 13 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 14 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 15 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 16 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 17 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 18 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
#line 19 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 34 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 110 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 136 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 169 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 213 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"



 
#line 225 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 243 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 259 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 277 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 303 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
{
    uint8_t            valid_data;      
    ble_gap_sec_keys_t local_kex;       
    ble_gap_sec_keys_t peer_kex;        
    ble_gap_enc_info_t local_enc_info;  
} bond_context_t;
...
{
    uint32_t size;                                      
    uint8_t  attributes[sizeof(uint32_t) * ((((((6 * (3 + 1)) + 2)) - 1) / (sizeof(uint32_t))) + 1)];  
} dm_gatts_context_t;
...
typedef char static_assert_failed[((0 % 4) == 0) ? 1 : -1];  
...
static void peer_instance_init(uint32_t index)
{
    ...
    memset(m_peer_table[index].peer_addr.addr, 0, 6);
    memset(m_peer_table[index].irk.irk, 0, 16);

    
    m_peer_table[index].peer_addr.addr_type = 0xFF;
    
    m_peer_table[index].id_bitmap      = 0xFF;
    
    m_peer_table[index].div            = 0xFFFF;
...
static __inline api_result_t device_instance_free(uint32_t device_index)
{
    ...
    if (err_code == ((0x0) + 0))
    {
        ...
        err_code = pstorage_clear(&block_handle, (((sizeof(peer_id_t)) + (sizeof(bond_context_t))) + ((sizeof(dm_gatts_context_t)) + (sizeof(dm_gatt_client_context_t))) + 0));
...
static api_result_t device_instance_find(ble_gap_addr_t const * p_addr, uint32_t * p_device_index, uint16_t div)
{
    ...
    for (index = 0; index < 7; index++)
    {
        ...
        if (((0 == p_addr) && (div == m_peer_table[index].div)) ||
            ((0 != p_addr) && (memcmp(&m_peer_table[index].peer_addr, p_addr, sizeof(ble_gap_addr_t)) == 0)))
        {
            ;
                                                 ...
                                                 dm_handle_t const       * p_handle)
{
    ...
    uint8_t           sys_data[sizeof(uint32_t) * ((((((6 * (3 + 1)) + 2)) - 1) / (sizeof(uint32_t))) + 1)];

    uint16_t attr_len = sizeof(uint32_t) * ((((((6 * (3 + 1)) + 2)) - 1) / (sizeof(uint32_t))) + 1);
...
static __inline api_result_t gatts_context_apply(dm_handle_t * p_handle)
{
    ...
    if ((m_gatts_table[p_handle->connection_id].size != 0) &&
        (
            ((m_connection_table[p_handle->connection_id].state & 0x40) == 0x40) &&
                                   ...
                                   uint32_t            data_len)
{
    ...
    if (data_len > (((sizeof(peer_id_t)) + (sizeof(bond_context_t))) + ((sizeof(dm_gatts_context_t)) + (sizeof(dm_gatt_client_context_t))) + 0))
    {
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1219, (uint8_t*) "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"); } while (0); } } while (0);
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        app_notify        = 0;
                        dm_event.event_id = 0x40;
#line 1374 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
                    }
                }
            }
        }
...
api_result_t dm_init(dm_init_param_t const * const p_init_param)
{
    ...
    for (index = 0; index < 7; index++)
    {
        ...
        m_irk_index_table[index]  = 0xFF;
    }

    
    param.block_size  = (((sizeof(peer_id_t)) + (sizeof(bond_context_t))) + ((sizeof(dm_gatts_context_t)) + (sizeof(dm_gatt_client_context_t))) + 0);
    param.block_count = 7;
            ...
            for (index = 0; index < 7; index++)
            {
                ...
                if (err_code == ((0x0) + 0))
                {
                    ...
                    else
                    {
                        ...
                        ;
#line 1495 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
                    }
                }
                else
                {
                                    ...
                                    dm_security_status_t * p_status)
{
    ...
    else if (m_connection_table[p_handle->connection_id].state & 0x40)
    {
        (*p_status) = ENCRYPTED;
    }
    else
                                 ...
                                 ble_gap_whitelist_t             * p_whitelist)
{
    ...
    for (uint32_t index = 0;
         ((index < 7) && (addr_count < p_whitelist->addr_count) &&
          (irk_count < p_whitelist->irk_count));
         index++)
    {
        if ((m_peer_table[index].id_bitmap & 0x01) == 0)
        {
        ...
        if ((m_peer_table[index].id_bitmap & 0x02) == 0)
        {
                                    ...
                                    dm_service_context_t const * p_context)
{
    ...
    if ((p_context->context_data.p_data != 0) &&
        (
            ...
            (p_context->context_data.len < sizeof(uint32_t) * ((((((6 * (3 + 1)) + 2)) - 1) / (sizeof(uint32_t))) + 1))
        )
       )
    {
...
api_result_t dm_application_context_set(dm_handle_t const              * p_handle,
                                        dm_application_context_t const * p_context)
{
#line 1917 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
    return ((((0x0) + 0x0080)+0x0011) | (0x8000));
...
api_result_t dm_application_context_get(dm_handle_t const        * p_handle,
                                        dm_application_context_t * p_context)
{
#line 1985 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
    return ((((0x0) + 0x0080)+0x0011) | (0x8000));
...
{
#line 2041 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
    return ((((0x0) + 0x0080)+0x0011) | (0x8000));
...
void bond_data_load(dm_handle_t * p_handle)
{
    ...
    {
        ;
#line 2300 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
void dm_ble_evt_handler(ble_evt_t * p_ble_evt)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 2359, (uint8_t*) "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"); } while (0); } } while (0);

    ble_gap_enc_info_t * p_enc_info = 0;
    event_result                    = ((0x0) + 0);
    err_code                        = ((0x0) + 0);
    ...
    switch (p_ble_evt->header.evt_id)
    {
        case BLE_GAP_EVT_CONNECTED:
            ...
            if (err_code == ((0x0) + 0))
            {
                ...
                {
                    if (m_irk_index_table[p_ble_evt->evt.gap_evt.params.connected.irk_match_idx] != 0xFF)
                    {
        ...
        case BLE_GAP_EVT_DISCONNECTED:
            ...
            {
                if ((m_connection_table[index].state & 0x40) == 0x40)
                {
        ...
        case BLE_GAP_EVT_SEC_INFO_REQUEST:
            ...
            if (m_connection_table[index].bonded_dev_id == 0xFF)
            {
                ...
                err_code = device_instance_find(0,&device_index, p_ble_evt->evt.gap_evt.params.sec_info_request.div);
                if (err_code == ((0x0) + 0))
                {
        ...
        case BLE_GAP_EVT_SEC_PARAMS_REQUEST:
            ...
            else
            {
                ...
                if (m_connection_table[index].bonded_dev_id != 0xFF)
                {
                    notify_app     = 1;
                    event.event_id = 0x16;
                    memset(m_gatts_table[index].attributes, 0, sizeof(uint32_t) * ((((((6 * (3 + 1)) + 2)) - 1) / (sizeof(uint32_t))) + 1));
        ...
        case BLE_GAP_EVT_AUTH_STATUS:
            ...
            else
            {
                ...
                if ((m_connection_table[index].state & 0x40) ==
                    0x40)
                {
                    m_connection_table[index].state |= 0x08;
                    ...
                    if (m_connection_table[index].bonded_dev_id == 0xFF)
                    {
                        ...
                        if (err_code == ((0x0) + 0))
                        {
                            ...
                            handle.device_id                        = device_index;
                            m_connection_table[index].bonded_dev_id = device_index;
                            m_peer_table[device_index].div          =                             p_ble_evt->evt.gap_evt.params.auth_status.periph_keys.enc_info.div;
