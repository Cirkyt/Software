#line 1 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_cscs.c"
...
#line 19 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_cscs.c"
...
#line 20 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_cscs.c"
#line 1 "..\\..\\..\\..\\..\\Include\\nordic_common.h"
...
#line 21 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_cscs.c"
#line 22 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_cscs.c"
#line 23 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_cscs.c"
#line 24 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_cscs.c"
...
#line 25 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_cscs.c"
...
#line 26 "..\\..\\..\\..\\..\\Source\\ble\\ble_services\\ble_cscs.c"
...
static uint32_t csc_measurement_char_add(ble_cscs_t * p_cscs, const ble_cscs_init_t * p_cscs_init)
{
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x2A5B;} while(0);
...
static uint32_t csc_feature_char_add(ble_cscs_t * p_cscs, const ble_cscs_init_t * p_cscs_init)
{
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x2A5C;} while(0);
...
static uint32_t csc_sensor_loc_char_add(ble_cscs_t * p_cscs, const ble_cscs_init_t * p_cscs_init)
{
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x2A5D;} while(0);
    ...
    if (p_cscs_init->sensor_location != 0)
    {
...
uint32_t ble_cscs_init(ble_cscs_t * p_cscs, const ble_cscs_init_t * p_cscs_init)
{
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x1816;} while(0);
...
uint32_t ble_cscs_measurement_send(ble_cscs_t * p_cscs, ble_cscs_meas_t * p_measurement)
{
    ...
    if (p_cscs->conn_handle != 0xFFFF)
    {
        ...
        ble_gatts_hvx_params_t hvx_params;
				...
				uint8_t count_ch = (uint8_t) count;
				len = sizeof(count_ch);
        hvx_len = len;
