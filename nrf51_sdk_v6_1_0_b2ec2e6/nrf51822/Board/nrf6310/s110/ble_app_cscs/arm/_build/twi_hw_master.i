#line 1 "..\\..\\..\\..\\..\\Source\\twi_master\\twi_hw_master.c"
...
#line 14 "..\\..\\..\\..\\..\\Source\\twi_master\\twi_hw_master.c"
#line 1 "..\\..\\..\\..\\..\\Include\\twi_master_config.h"
...
#line 15 "..\\..\\..\\..\\..\\Source\\twi_master\\twi_hw_master.c"
#line 16 "..\\..\\..\\..\\..\\Source\\twi_master\\twi_hw_master.c"
#line 17 "..\\..\\..\\..\\..\\Source\\twi_master\\twi_hw_master.c"
#line 1 "..\\..\\..\\..\\..\\Include\\nrf.h"
...
#line 18 "..\\..\\..\\..\\..\\Source\\twi_master\\twi_hw_master.c"
#line 1 "..\\..\\..\\..\\..\\Include\\nrf_delay.h"
...
#line 19 "..\\..\\..\\..\\..\\Source\\twi_master\\twi_hw_master.c"
#line 1 "..\\..\\..\\..\\..\\Include\\nrf_gpio.h"
...
#line 20 "..\\..\\..\\..\\..\\Source\\twi_master\\twi_hw_master.c"


 


static _Bool twi_master_write(uint8_t * data, uint8_t data_length, _Bool issue_stop_condition)
{
    uint32_t timeout = (20000UL);  
    ...
    ((NRF_TWI_Type *) 0x40004000UL)->TXD           = *data++;
    ((NRF_TWI_Type *) 0x40004000UL)->TASKS_STARTTX = 1;

     
    while (1)
    {
        while (((NRF_TWI_Type *) 0x40004000UL)->EVENTS_TXDSENT == 0 && ((NRF_TWI_Type *) 0x40004000UL)->EVENTS_ERROR == 0 && (--timeout))
        {
            
        }

        if (timeout == 0 || ((NRF_TWI_Type *) 0x40004000UL)->EVENTS_ERROR != 0)
        {
            
            
            
            ((NRF_TWI_Type *) 0x40004000UL)->EVENTS_ERROR = 0;
            ((NRF_TWI_Type *) 0x40004000UL)->ENABLE       = (0x00UL) << (0UL); 
            ((NRF_TWI_Type *) 0x40004000UL)->POWER        = 0;
            nrf_delay_us(5);
            ((NRF_TWI_Type *) 0x40004000UL)->POWER        = 1;
            ((NRF_TWI_Type *) 0x40004000UL)->ENABLE       = (0x05UL) << (0UL);

            (void)twi_master_init();

            return 0;
        }
        ((NRF_TWI_Type *) 0x40004000UL)->EVENTS_TXDSENT = 0;
        if (--data_length == 0)
        {
            break;
        }
    ...
    {
        ((NRF_TWI_Type *) 0x40004000UL)->EVENTS_STOPPED = 0;
        ((NRF_TWI_Type *) 0x40004000UL)->TASKS_STOP     = 1;
          
        while(((NRF_TWI_Type *) 0x40004000UL)->EVENTS_STOPPED == 0) 
        {
...
static _Bool twi_master_read(uint8_t * data, uint8_t data_length, _Bool issue_stop_condition)
{
    uint32_t timeout = (20000UL);  
    ...
    {
        ((NRF_PPI_Type *) 0x4001F000UL)->CH[0].TEP = (uint32_t)&((NRF_TWI_Type *) 0x40004000UL)->TASKS_STOP;
    }
    else
    {
        ((NRF_PPI_Type *) 0x4001F000UL)->CH[0].TEP = (uint32_t)&((NRF_TWI_Type *) 0x40004000UL)->TASKS_SUSPEND;
    }

    ((NRF_PPI_Type *) 0x4001F000UL)->CHENSET          = (0x1UL << (0UL));
    ((NRF_TWI_Type *) 0x40004000UL)->EVENTS_RXDREADY = 0;
    ((NRF_TWI_Type *) 0x40004000UL)->TASKS_STARTRX   = 1;

     
    while (1)
    {
        while (((NRF_TWI_Type *) 0x40004000UL)->EVENTS_RXDREADY == 0 && ((NRF_TWI_Type *) 0x40004000UL)->EVENTS_ERROR == 0 && (--timeout))
        {
        ...
        *data++ = ((NRF_TWI_Type *) 0x40004000UL)->RXD;
        ...
        nrf_delay_us(20);
        ((NRF_TWI_Type *) 0x40004000UL)->TASKS_RESUME = 1;
    }
    ...
    ((NRF_PPI_Type *) 0x4001F000UL)->CHENCLR = (0x1UL << (0UL));
    return 1;
}
...
static _Bool twi_master_clear_bus(void)
{
    uint32_t twi_state;
    _Bool     bus_clear;
    ...
    twi_state        = ((NRF_TWI_Type *) 0x40004000UL)->ENABLE;
    ((NRF_TWI_Type *) 0x40004000UL)->ENABLE = (0x00UL) << (0UL);

    clk_pin_config =         ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[(2U)];

    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[(2U)] =              ((0x00UL)  << (16UL))       | ((0x06UL)    << (8UL))         | ((0x03UL)   << (2UL))          | ((0UL) << (1UL))         | ((1UL)    << (0UL));
    ...
    data_pin_config =         ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[(3U)];

    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[(3U)] =               ((0x00UL)  << (16UL))       | ((0x06UL)    << (8UL))         | ((0x03UL)   << (2UL))          | ((0UL) << (1UL))         | ((1UL)    << (0UL));
    ...
    do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << (3U)); } while(0);
    do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << (2U)); } while(0);
    nrf_delay_us(4);

    if ((((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (3U)) & 0x1UL) == 1) && (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (2U)) & 0x1UL) == 1))
    {
        bus_clear = 1;
    }
    else
    {
        ...
        for (i=18; i--;)
        {
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (1UL << (2U)); } while(0);
            nrf_delay_us(4);
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << (2U)); } while(0);
            nrf_delay_us(4);

            if (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (3U)) & 0x1UL) == 1)
            {
                bus_clear = 1;
                break;
            }
    ...
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[(2U)] = clk_pin_config;
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[(3U)]  = data_pin_config;

    ((NRF_TWI_Type *) 0x40004000UL)->ENABLE = twi_state;
...
_Bool twi_master_init(void)
{
    ...
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[(2U)] =             ((0x00UL) << (16UL))       | ((0x06UL)     << (8UL))       | ((0x03UL)    << (2UL))        | ((0UL)  << (1UL))       | ((0UL)      << (0UL));
    ...
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[(3U)] =              ((0x00UL) << (16UL))       | ((0x06UL)     << (8UL))       | ((0x03UL)    << (2UL))        | ((0UL)  << (1UL))       | ((0UL)      << (0UL));
    ...
    ((NRF_TWI_Type *) 0x40004000UL)->EVENTS_RXDREADY = 0;
    ((NRF_TWI_Type *) 0x40004000UL)->EVENTS_TXDSENT  = 0;
    ((NRF_TWI_Type *) 0x40004000UL)->PSELSCL         = (2U);
    ((NRF_TWI_Type *) 0x40004000UL)->PSELSDA         = (3U);
    ((NRF_TWI_Type *) 0x40004000UL)->FREQUENCY       = (0x01980000UL) << (0UL);
    ((NRF_PPI_Type *) 0x4001F000UL)->CH[0].EEP        = (uint32_t)&((NRF_TWI_Type *) 0x40004000UL)->EVENTS_BB;
    ((NRF_PPI_Type *) 0x4001F000UL)->CH[0].TEP        = (uint32_t)&((NRF_TWI_Type *) 0x40004000UL)->TASKS_SUSPEND;
    ((NRF_PPI_Type *) 0x4001F000UL)->CHENCLR          = (0x1UL << (0UL));
    ((NRF_TWI_Type *) 0x40004000UL)->ENABLE          = (0x05UL) << (0UL);
...
_Bool twi_master_transfer(uint8_t   address,
                         uint8_t * data,
                         uint8_t   data_length,
                         _Bool      issue_stop_condition)
{
    _Bool transfer_succeeded = 0;
    if (data_length > 0 && twi_master_clear_bus())
    {
        ((NRF_TWI_Type *) 0x40004000UL)->ADDRESS = (address >> 1);
