...
#line 40 "..\\main.c"
#line 1 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_cscs.h"
...
#line 49 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_cscs.h"
#line 50 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_cscs.h"
#line 51 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_cscs.h"
#line 52 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_cscs.h"
...
#line 53 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_cscs.h"
#line 54 "..\\..\\..\\..\\..\\Include\\ble\\ble_services\\ble_cscs.h"
...
{
    _Bool        is_wheel_rev_data_present;                               
    _Bool        is_crank_rev_data_present;                               
...
static ble_sensorsim_cfg_t                   m_speed_kph_sim_cfg;                        
static ble_sensorsim_state_t                 m_speed_kph_sim_state;                      
static ble_sensorsim_cfg_t                   m_crank_rpm_sim_cfg;                        
static ble_sensorsim_state_t                 m_crank_rpm_sim_state;                      

static app_timer_id_t                        m_battery_timer_id;                         
static app_timer_id_t                        m_csc_meas_timer_id;                        
static dm_application_instance_t             m_app_handle;                               
static uint32_t                              m_cumulative_wheel_revs;                    
static _Bool                                  m_auto_calibration_in_progress;             
...
static void battery_level_update(void)
{
    ...
    {
        do { app_error_handler((err_code), 213, (uint8_t*) "..\\main.c"); } while (0);
    }
}
...
static void csc_sim_measurement(ble_cscs_meas_t * p_measurement)
{
    ...
    event_time_inc = (1024 * 1000) / 1000;

    
    p_measurement->is_wheel_rev_data_present = 1;

    mm_per_sec = 278 * ble_sensorsim_measure(&m_speed_kph_sim_state,
                                                           &m_speed_kph_sim_cfg);

    wheel_revolution_mm   += mm_per_sec * 1000 / 1000;
    m_cumulative_wheel_revs += wheel_revolution_mm / 2100;
    wheel_revolution_mm   %= 2100;
    ...
    p_measurement->is_crank_rev_data_present = 1;

    degrees_per_sec = 6 * ble_sensorsim_measure(&m_crank_rpm_sim_state,
                                                                     &m_crank_rpm_sim_cfg);

    crank_rev_degrees     += degrees_per_sec * 1000 / 1000;
    cumulative_crank_revs += crank_rev_degrees / 360;
    crank_rev_degrees     %= 360;
...
static void csc_meas_timeout_handler(void * p_context)
{
    ...
    {
        do { app_error_handler((err_code), 304, (uint8_t*) "..\\main.c"); } while (0);
    }
    if (m_auto_calibration_in_progress)
    {
        ...
        {
            do { app_error_handler((err_code), 314, (uint8_t*) "..\\main.c"); } while (0);
        }
        if (err_code != ((0x3000)+0x004))
        {
            m_auto_calibration_in_progress = 0;
        }
    }
}
...
static void timers_init(void)
{
    ...
    do { static uint32_t APP_TIMER_BUF[((((( (((4)) * 40) + ( 3 * (8 + (((4) + 1) + 1) * 24) ) )) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_timer_init((0), (4), (4) + 1, APP_TIMER_BUF, (0) ? app_timer_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 345, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);

    
    err_code = app_timer_create(&m_battery_timer_id,
                                APP_TIMER_MODE_REPEATED,
                                battery_level_meas_timeout_handler);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 351, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    
    err_code = app_timer_create(&m_csc_meas_timer_id,
                                APP_TIMER_MODE_REPEATED,
                                csc_meas_timeout_handler);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 357, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void gap_params_init(void)
{
    ...
    err_code = sd_ble_gap_appearance_set(1157);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 380, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
ble_scpt_response_t sc_ctrlpt_event_handler(ble_sc_ctrlpt_t * p_sc_ctrlpt, ble_sc_ctrlpt_evt_t * p_evt)
{
    switch (p_evt->evt_type)
    {
        ...
        case BLE_SC_CTRLPT_EVT_START_CALIBRATION:
            m_auto_calibration_in_progress = 1;
            break;
        default:
...
static void services_init(void)
{
    ...
    cscs_init.evt_handler = 0;
    cscs_init.feature     = (0x01 << 0) | (0x01 << 1) | (0x01 << 2);

    
    do {(&cscs_init . csc_meas_attr_md . cccd_write_perm)->sm = 1; (&cscs_init . csc_meas_attr_md . cccd_write_perm)->lv = 1;} while(0);    
    do {(&cscs_init . csc_feature_attr_md . read_perm)->sm = 1; (&cscs_init . csc_feature_attr_md . read_perm)->lv = 1;} while(0);       
    do {(&cscs_init . csc_ctrlpt_attr_md . write_perm)->sm = 1; (&cscs_init . csc_ctrlpt_attr_md . write_perm)->lv = 1;} while(0);       
    do {(&cscs_init . csc_ctrlpt_attr_md . cccd_write_perm)->sm = 1; (&cscs_init . csc_ctrlpt_attr_md . cccd_write_perm)->lv = 1;} while(0);  
    
    cscs_init.ctrplt_supported_functions    = 0x02
                                              |0x01
                                              |0x04;
    ...
    do {(&cscs_init . csc_sensor_loc_attr_md . read_perm)->sm = 1; (&cscs_init . csc_sensor_loc_attr_md . read_perm)->lv = 1;} while(0);    
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 513, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 524, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void sensor_sim_init(void)
{
    ...
    m_speed_kph_sim_cfg.min          = 10;
    m_speed_kph_sim_cfg.max          = 40;
    m_speed_kph_sim_cfg.incr         = 1;
    m_speed_kph_sim_cfg.start_at_max = 0;

    ble_sensorsim_init(&m_speed_kph_sim_state, &m_speed_kph_sim_cfg);

    m_crank_rpm_sim_cfg.min          = 20;
    m_crank_rpm_sim_cfg.max          = 110;
    m_crank_rpm_sim_cfg.incr         = 3;
    m_crank_rpm_sim_cfg.start_at_max = 0;
...
static void application_timers_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 567, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    csc_meas_timer_ticks = ((uint32_t)((((1000) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000)));

    err_code = app_timer_start(m_csc_meas_timer_id, csc_meas_timer_ticks, 0);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 572, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void advertising_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 595, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void on_conn_params_evt(ble_conn_params_evt_t * p_evt)
{
    ...
    if (p_evt->evt_type == BLE_CONN_PARAMS_EVT_FAILED)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 618, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    }
}
...
{
    do { app_error_handler((nrf_error), 629, (uint8_t*) "..\\main.c"); } while (0);
}
...
static void conn_params_init(void)
{
    ...
    connection_params_init.p_conn_params                  = 0;
    connection_params_init.first_conn_params_update_delay = ((uint32_t)((((5000) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000)));
    connection_params_init.next_conn_params_update_delay  = ((uint32_t)((((30000) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000)));
    ...
    connection_params_init.disconnect_on_fail             = 0;
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 652, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void ble_stack_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 767, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    
    err_code = softdevice_ble_evt_handler_set(ble_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 771, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    
    err_code = softdevice_sys_evt_handler_set(sys_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 775, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static uint32_t device_manager_evt_handler(dm_handle_t const    * p_handle,
                                           ...
                                           api_result_t           event_result)
{
    do { const uint32_t LOCAL_ERR_CODE = (event_result); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 803, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    return ((0x0) + 0);
}
...
static void device_manager_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 818, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    
    init_data.clear_persistent_data = (nrf_gpio_pin_read(1) == 0);

    err_code = dm_init(&init_data);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 824, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 839, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void power_manage(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 848, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
int main(void)
{
		...
		static struct platform_data gyro_orient = {
			.orientation = {0, 1, 0, -1, 0, 0, 0, 0, 1}
		};
  
		static struct platform_data accel_orient = {
			.orientation = {0, 1, 0, -1, 0, 0, 0, 0, 1}
		};
		...
		dmp_set_orientation(inv_orientation_matrix_to_scalar(gyro_orient.orientation));
		dmp_set_orientation(inv_orientation_matrix_to_scalar(accel_orient.orientation));
		dmp_enable_feature((0x10) | (0x08));
		dmp_set_interrupt_mode((0x02));
